...
<form action="{{ asset('form/cdo_addv1') }}" method="POST" class="form-submit">
    {{ csrf_field() }}
    <div class="modal-body">
        ...
        <table class="table table-hover table-form table-striped">
            ...
            <tr>
                ...
                <td class="col-sm-1"><strong>:</strong></td>
                <td class="col-sm-8"><input class="form-control datepickercalendar" value="{{ date('m/d/Y') }}" name="date" required></td>
            </tr>
            <tr>
