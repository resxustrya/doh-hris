    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a target="_blank" href="<?php echo e(asset('pdf')); ?>" class="btn btn-success"><i class="fa fa-barcode"></i> Generate Barcode</a>
                <a target="_blank" href="<?php echo e(asset('pdf/track')); ?>" class="btn btn-success"><i class="fa fa-barcode"></i> Generate Barcode v2</a>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
