...
?>
<form action="<?php echo e(asset('calendar_save')); ?>" method="POST">
    <input type="hidden" name="background_color" value="<?php echo e(random_color()); ?>">
    <input type="hidden" name="border_color" value="<?php echo e(random_color()); ?>">
