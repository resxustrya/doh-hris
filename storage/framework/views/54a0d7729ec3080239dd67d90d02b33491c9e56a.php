...
<body>
    <form action="<?php echo e($data['asset']); ?>" method="POST" class="form-submit">
    ...
    <div class="new-times-roman table-responsive">
            ...
            <tr>
                <td class="col-sm-7">
                    <table class="table table-list table-hover table-striped">
                        ...
                        <tr>
                            <td><input type="text" value="<?php echo e($data['cdo']['beginning_balance']); ?>" class="form-control" name="beginning_balance" maxlength="15"
                                <?php
                            ...
                            <td><input type="text" value="<?php echo e($data['cdo']['less_applied_for']); ?>" class="form-control" name="less_applied" maxlength="15"
                                <?php
                                    if($data['type'] == 'add' || !\Illuminate\Support\Facades\Auth::user()->usertype)
                                        echo 'disabled';
                                    else{
                            ...
                            <td><input type="text" value="<?php echo e($data['cdo']['remaining_balance']); ?>" class="form-control" name="remaining_balance" maxlength="15"
                                <?php
                                    if($data['type'] == 'add' || !\Illuminate\Support\Facades\Auth::user()->usertype)
                                        echo 'disabled';
                                    else{
                        ...
                        <tr>
                            <td class="align">
                                <select  class="chosen-select-static form-control" name="immediate_supervisor" required>
                                    <?php if($data['type'] == 'update'): ?>
                                        <option value="<?php echo e($data['section_head'][0]['id']); ?>"><?php echo e($data['section_head'][0]['fname'].' '.$data['section_head'][0]['mname'].' '.$data['section_head'][0]['lname']); ?></option>
                                    <?php endif; ?>
                                    <?php foreach($data['section_head'] as $section_head): ?>
                                        <?php if($data['section_head'][0]['id'] != $section_head['id'] and $data['type'] == 'update'): ?>
                                            <option value="<?php echo e($section_head['id']); ?>"><?php echo e($section_head['fname'].' '.$section_head['mname'].' '.$section_head['lname']); ?></option>
                                        <?php elseif($data['type'] == 'add'): ?>
                                            <option value="<?php echo e($section_head['id']); ?>"><?php echo e($section_head['fname'].' '.$section_head['mname'].' '.$section_head['lname']); ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <tr>
                            <td class="align">
                                ...
                                <select  class="form-control" name="division_chief" required>
                                    <?php if($data['type'] == 'update'): ?>
                                        <option value="<?php echo e($data['division_head'][0]['id']); ?>"><?php echo e($data['division_head'][0]['fname'].' '.$data['division_head'][0]['mname'].' '.$data['division_head'][0]['lname']); ?></option>
                                    <?php endif; ?>
                                    <?php foreach($data['division_head'] as $division_head): ?>
                                        <?php if($data['division_head'][0]['id'] != $division_head['id'] and $data['type'] == 'update'): ?>
                                            <option value="<?php echo e($division_head['id']); ?>"><?php echo e($division_head['fname'].' '.$division_head['mname'].' '.$division_head['lname']); ?></option>
                                        <?php elseif($data['type'] == 'add'): ?>
                                            <option value="<?php echo e($division_head['id']); ?>"><?php echo e($division_head['fname'].' '.$division_head['mname'].' '.$division_head['lname']); ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
        ...
        <?php if($data['type'] == "update"): ?>
            <div class="modal-footer">
                ...
                <a target="_blank" href="<?php echo e(asset('form/cdov1/pdf')); ?>" class="btn btn-success" style="color:white"><i class="fa fa-barcode"></i> Barcode v3</a>
