<ul class="nav navbar-nav">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li>
                <a href="<?php echo e(asset('/employee-attendance')); ?>"><i class="fa fa-unlock"></i>&nbsp;&nbsp; Employee attendance</a>
            </li>
            <li class="divider"></li>
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a href="<?php echo e(asset('print-monthly')); ?>"><i class="fa fa-check"></i>&nbsp;&nbsp; Employees monthly attendance</a></li>
            <li class="divider"></li>
