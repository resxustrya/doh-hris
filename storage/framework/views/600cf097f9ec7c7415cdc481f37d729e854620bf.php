...
<?php for($i = 0; $i < count($lists); $i++): ?>
    <div style="height: 700px;width: 750px;margin-left: -10px;padding: 0px;">
        <div style="height: 600px;width: 350px;float: left;">
            ...
            <span style="font-size: 10px;margin-left: 115px;">Printed : <?php echo e(date('m/d/Y')); ?></span>
            ...
            <span style="font-size: 10px;margin-left: 115px;">ID NO. : <?php echo e($lists[$i]['userid']); ?></span>
            <br />
            <br />
