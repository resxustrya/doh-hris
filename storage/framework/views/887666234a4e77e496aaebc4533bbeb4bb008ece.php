    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="dropdown-submenu">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo e(asset('form/leave')); ?>"  data-toggle="modal">Leave</a></li>
                    <li class="divider"></li>
                    <li><a href="#document_form" data-backdrop="static" data-toggle="modal" data-link="<?php echo e(asset('form/so')); ?>">Office Order</a></li>
                    <li class="divider"></li>
